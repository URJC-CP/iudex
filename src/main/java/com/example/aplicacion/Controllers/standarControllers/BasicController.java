...
public class BasicController {
    ...
    @PostConstruct
    public void init() {
        logger.info("Build Java language image ");
        ...
        logger.info("Finish build Java language image " + imageId + " from " + dckfl.getName());

        //Creamos el lenguaje Python
        logger.info("Build Python language image");
        ...
        logger.info("Finish build Python language image " + imageId2 + " from " + dckfl2.getName());

        //Creamos el lenguaje C
        logger.info("Build language image");
        ...
        logger.info("Finish build C language image " + imageId3 + " from " + dckfl3.getName());

        //Creamos el lenguaje CPP
        logger.info("Build C++ language image");
        ...
        logger.info("Finish build C++ language image " + imageId4 + " from " + dckfl4.getName());
