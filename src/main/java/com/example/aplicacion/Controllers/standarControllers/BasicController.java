...
public class BasicController {
    ...
    @PostConstruct
    public void init() {
        if (languageRepository.findLanguageByNombreLenguaje("java").isEmpty()) {
        ...
        if (languageRepository.findLanguageByNombreLenguaje("python3").isEmpty()) {
        ...
        if (languageRepository.findLanguageByNombreLenguaje("c").isEmpty()) {
        ...
        if (languageRepository.findLanguageByNombreLenguaje("cpp").isEmpty()) {
            logger.info("Build C++ image");
        ...
        if (languageRepository.findLanguageByNombreLenguaje("sql").isEmpty()) {
